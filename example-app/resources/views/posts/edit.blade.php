                ...
                <div class="card-body">
                    <form action="{{route('posts.update',$posts->id)}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group required mt-2 mb-2">
                            <button type="button" data-bs-toggle="collapse" data-bs-target="#demo"  class="btn btn-success">View Image</button>
                            <div id="demo" class="collapse text-center">
                                <img src="{{asset('post_image/'.$posts->image)}}" style="width: 200px; height: 300px"/>
                            </div>
                        </div>
                        <div class="form-group required">
